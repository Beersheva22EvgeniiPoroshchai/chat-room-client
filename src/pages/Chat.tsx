...
const Chat: React.FC = () => {
    ...
    const columnsAdmin: GridColDef[] = [
        {
            field: 'actions', headerName: 'Admin Actions', flex: 0.5, headerClassName: 'data-grid-header',
...
setOpenConfirm(false);
 ...
 <SetMessages messages={messageArray}></SetMessages>
    <Box sx={{ height: '80vh', width: '95vw', mt: '1vh' }}>
        <DataGrid onRowClick={(params) => onClickFn(params)} columns={columns} rows={getActualAccountsRows(accounts)} />
    </Box>
